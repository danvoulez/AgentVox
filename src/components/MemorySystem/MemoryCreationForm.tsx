...
const MemoryCreationForm: React.FC<MemoryCreationFormProps> = ({ onClose, memoryTypes }) => {
  ...
  const [structuredContent, setStructuredContent] = useState({
    ...
    description: '',
    details: '',
    links: [] as string[] as string[] as string[]
  });
        ...
        <div className="px-6 py-4 overflow-y-auto max-h-[calc(90vh-8rem)]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                value={memoryType}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMemoryType(e.target.value)}
              ...
              <p className="mt-1 text-xs text-gray-500">
                {memoryTypes.find((t: any) => t.id === memoryType)?.description}
              </p>
            </div>
            ...
            {contentType === 'simple' ? (
              <div>
                ...
                <textarea
                  value={simpleContent}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSimpleContent(e.target.value)}
                  rows={8}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStructuredContent({ ...structuredContent, title: e.target.value })}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStructuredContent({ ...structuredContent, description: e.target.value })}
                    rows={3}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStructuredContent({ ...structuredContent, details: e.target.value })}
                    rows={5}
