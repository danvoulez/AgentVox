// Script para atualizar a chave do Supabase no arquivo .env.local com a chave correta
const fs = require('fs');
const path = require('path');

console.log('=== ATUALIZAÇÃO COM A CHAVE CORRETA ===\n');

// Caminho para o arquivo .env.local
const envFile = path.join(__dirname, '.env.local');

// Chave do Supabase da imagem (linha 2)
