// Script para atualizar a chave do Supabase no arquivo .env.local com a chave exata da imagem
const fs = require('fs');
const path = require('path');

console.log('=== ATUALIZAÇÃO COM A CHAVE EXATA DA IMAGEM ===\n');
...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im53dnh6bGtob29idG90dWl4dnBuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA2NjUwNTAsImV4cCI6MjA1NjI0MTA1MH0.-BHyRvjNy--BHYRvjNX--BHYRvjNy--BHYRvjNy--BHYRvjNy';
